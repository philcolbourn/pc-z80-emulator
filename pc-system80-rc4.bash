...
test_overlap_code(){
    setupMMgr 0x0000-0x0600  RAM RW             # define 0000-0600 as RW
    # CALL 0200 and CALL 0201 overlap
    # 0200 is LD A,n; LD C,B; LD B,C; LD A,B6
    # 0201 is LD BC,nn; LD A,B6
...
case "$1" in
  ZEXDOC) zexdoc "$2";;
  TESTOVERLAP) test_overlap_code;;
  SYSTEM80) system80;;
  TESTS) tests $2;;
  TESTSDEV) tests_dev $2;;
  TESTFAST) # test debug and fast versions
  ...
  C) gcc pc-z80-4.c 2>&1 | head -n 10;;  # compile c version
  *) system80
esac

# to run space invaders, enter >system
# system
# INVADE (hold down shift)
# /
