...
#printf "LDAmm() { rmm;rb \$mm;a=n;} # from $0.$LINENO\n"
printf "LDAmm(){ rmm;memread \$mm;a=MEM[mm];} # from $0.$LINENO\n"
#printf "LDmmA(){ rmm;wb \$mm \$a;} # from $0.$LINENO\n"
printf "LDmmA(){ rmm;memprotb \$mm \$a;MEM[mm]=a;} # from $0.$LINENO\n"
#printf "LDAmm() { $rmm;rb \$mm;a=n;} # from $0.$LINENO\n"
#printf "LDmmA() { $rmm;wb \$mm \$a;} # from $0.$LINENO\n"
#printf "LDBCmA(){ wb $BCV \$a;} # from $0.$LINENO\n"
#printf "LDDEmA(){ wb $DEV \$a;} # from $0.$LINENO\n"
printf "LDBCmA(){ (($BC));memprotb \$bc \$a;MEM[bc]=a;} # from $0.$LINENO\n"
printf "LDDEmA(){ (($DE));memprotb \$de \$a;MEM[de]=a;} # from $0.$LINENO\n"

#printf "LDABCm(){ rb $BCV;a=n;} # from $0.$LINENO\n"
#printf "LDADEm(){ rb $DEV;a=n;} # from $0.$LINENO\n"
printf "LDABCm(){ (($BC));memread \$bc;a=MEM[bc];} # from $0.$LINENO\n"
printf "LDADEm(){ (($DE));memread \$de;a=MEM[de];} # from $0.$LINENO\n"

printf "# Jumps, calls and returns - timing checked\n"
#printf "JPnn() { rnn;pc=nn;} # from $0.$LINENO\n"
#printf "JRn() { rD;(( $NNPCD, pc=nn ));} # from $0.$LINENO\n"
#printf "JRn() { rD;(( $PCD ));} # from $0.$LINENO\n"
printf "JPnn(){ rpc;} # from $0.$LINENO\n"
printf "JRn(){ rPCD;} # from $0.$LINENO\n"
#printf "CALLnn(){ rnn;pushpcnn;} # from $0.$LINENO\n"
printf "CALLnn(){ rnn;((MEM[--sp]=pc>>8,MEM[--sp]=pc&255,pc=nn));} # from $0.$LINENO\n"
#printf "CALLnn(){ $rnn;(( MEM[--sp]=pc>>8, MEM[--sp]=pc&255, pc=nn ));} # from $0.$LINENO\n"
printf "RET(){ $poppc;} # from $0.$LINENO\n"
printf "RETI(){ $poppc;iff1=iff2;} # from $0.$LINENO\n"
printf "RETN(){ $poppc;iff1=iff2;} # from $0.$LINENO\n"
...
#printf "JP${N}nn(){ rnn;((f&F$F?0:(pc=nn)));} # from $0.$LINENO\n"
#printf "JP${S}nn(){ rnn;((f&F$F?(pc=nn):0));} # from $0.$LINENO\n"
#printf "JR${N}n(){ rD;(($NNPCD,f&F$F?0:(pc=nn)));} # from $0.$LINENO\n"
#printf "JR${S}n(){ rD;(($NNPCD,f&F$F?(pc=nn):0 ));} # from $0.$LINENO\n"
#printf "JR${N}n(){ rD;((f&F$F?0:($PCD)));} # from $0.$LINENO\n"
#printf "JR${S}n(){ rD;((f&F$F?($PCD):0));} # from $0.$LINENO\n"
printf "JP${N}nn(){ rjjcc;((pc=(f&F$F)?cc:jj));} # from $0.$LINENO\n"
printf "JP${S}nn(){ rjjcc;((pc=(f&F$F)?jj:cc));} # from $0.$LINENO\n"
printf "JR${N}n(){ rDjjcc;((pc=(f&F$F)?cc:jj));} # from $0.$LINENO\n"
printf "JR${S}n(){ rDjjcc;((pc=(f&F$F)?jj:cc));} # from $0.$LINENO\n"
#printf "CALL${S}nn(){ rnn;if(( (f&F$F)));then pushpcnn;fi;} # from $0.$LINENO\n"
#printf "RET$N(){ if((!(f&F$F)));then poppc;fi;} # from $0.$LINENO\n"
#printf "RET$S(){ if(( (f&F$F)));then poppc;fi;} # from $0.$LINENO\n"
#printf "CALL${N}nn(){ rnn;if((!(f&F$F)));then pushpcnn;fi;} # from $0.$LINENO\n"
#printf "CALL${N}nn(){ rnn;if((!(f&F$F)));then ((MEM[--sp]=pc>>8,MEM[--sp]=pc&255,pc=nn));fi;} # from $0.$LINENO\n"
#printf "CALL${N}nn(){ $rnn;if((!(f&F$F)));then pushpcnn;fi;} # from $0.$LINENO\n"
# I test sed rules with this line
#printf "CALL${S}nn(){ rnn;if(((f&F$F)));then { pushpcnn;};else { return 0;};fi;} # from $0.$LINENO\n"
printf "CALL${N}nn(){ rnn;(((f&F$F)?0:(MEM[--sp]=pc>>8,MEM[--sp]=pc&255,pc=nn)));} # from $0.$LINENO\n"
printf "CALL${S}nn(){ rnn;(((f&F$F)?(MEM[--sp]=pc>>8,MEM[--sp]=pc&255,pc=nn):0));} # from $0.$LINENO\n"

#printf "RET$N(){ ((!(f&F$F)))&&poppc||} # from $0.$LINENO\n"
#printf "RET$S(){ (( (f&F$F)))&&poppc||} # from $0.$LINENO\n"
#printf "RET$N(){ if((!(f&F$F)));then { $poppc;};else fi;} # from $0.$LINENO\n"
#printf "RET$S(){ if(( (f&F$F)));then { $poppc;};else fi;} # from $0.$LINENO\n"
#printf "RET$N(){ if((!(f&F$F)));then { ((pc=MEM[sp++],pc+=MEM[sp++]*256));};fi;} # from $0.$LINENO\n"
#printf "RET$S(){ if(( (f&F$F)));then { ((pc=MEM[sp++],pc+=MEM[sp++]*256));};fi;} # from $0.$LINENO\n"
#printf "RET$N(){ ((!(f&F$F)))&&((pc=MEM[sp++],pc+=MEM[sp++]*256));} # from $0.$LINENO\n"
#printf "RET$S(){ (( (f&F$F)?(pc=MEM[sp++],pc+=MEM[sp++]*256):0));} # from $0.$LINENO\n"
#badprintf "RET$N(){ (((f&F$F)?(pc=MEM[sp]+MEM[sp+1]*256,sp+=2):0));} # from $0.$LINENO\n"
#badprintf "RET$S(){ (((f&F$F)?0:(pc=MEM[sp]+MEM[sp+1]*256,sp+=2)));} # from $0.$LINENO\n"
#printf "RET$N(){ ((f&F$F))||((pc=MEM[sp++],pc+=MEM[sp++]*256));} # from $0.$LINENO\n"
#printf "RET$S(){ printf \"%%04x %%02x \" \$pc \$((f&F$F));((f&F$F))&&((pc=MEM[sp++],pc+=(MEM[sp++]<<8)));printf \"%%04x\\\n\" \$pc;} # from $0.$LINENO\n"
#printf "RET$N(){ (((f&F$F)?0:(pc=MEM[sp++],pc+=(MEM[sp++]<<8))));} # from $0.$LINENO\n"
#printf "RET$S(){ printf \"%%04x %%02x \" \$pc \$((f&F$F));(((f&F$F)>0?(pc=MEM[sp++],pc+=(MEM[sp++]<<8)):0));printf \"%%04x\\\n\" \$pc;} # from $0.$LINENO\n"
#printf "RET$S(){ printf ".";(((f&F$F)?(pc=MEM[sp++],pc+=(MEM[sp++]<<8)):0));printf "c";} # from $0.$LINENO\n"
#printf "RET$S(){ printf ".";((f&F$F?(${poppc//;/,}):0));printf "c";} # from $0.$LINENO\n"
printf "RET$N(){ ((f&F$F?0:(pc=MEM[sp++],pc+=(MEM[sp++]<<8))));} # from $0.$LINENO\n"
#printf "RET$S(){ ((f&F$F?(pc=MEM[sp++],pc+=(MEM[sp++]<<8)):0));} # from $0.$LINENO\n"
printf "RET$S(){ ((f&F$F?pc=MEM[sp++],pc+=(MEM[sp++]<<8):0));} # from $0.$LINENO\n"
done
...
#printf "DJNZn(){ rD;(($NNPCD,b=(b-1)&255,b?(pc=nn):0 ));} # from $0.$LINENO\n"
#printf "DJNZn(){ rD;((b=(b-1)&255,b?($PCD):0 ));} # from $0.$LINENO\n"
printf "DJNZn(){ rDjjcc;((b=(b-1)&255,pc=(b?jj:cc) ));} # from $0.$LINENO\n"
#printf "DJNZn(){ rDjjcc;((b--,b&=255,pc=(b?jj:cc)));} # from $0.$LINENO\n"

printf "NOP() { return 0;} # from $0.$LINENO\n"
printf "HALT(){ halt=1;} # from $0.$LINENO\n"

printf "DI(){ iff1=iff2=0;} # from $0.$LINENO\n"
printf "EI(){ iff1=iff2=1;} # from $0.$LINENO\n"
...
printf "LDIA(){ i=a;} # from $0.$LINENO\n"
printf "LDAI(){ a=i;} # from $0.$LINENO\n"
printf "LDRA(){ ((r7=a&0x80,r=a));} # from $0.$LINENO\n"
printf "LDAR(){ a=r;} # from $0.$LINENO\n"


printf "# IN and OUT - timing checked\n"
printf "OUTnA(){ rn;wp \$n \$a;} # from $0.$LINENO\n"
printf "INAn(){ rm;rp \$m;a=n;} # from $0.$LINENO\n"

for r1 in a f b c d e h l;do R1="${RN[$r1]}"
printf "IN${R1}C(){ rp \$c;\$$r1=n;} # from $0.$LINENO\n"
...
printf "CPL(){ ((m=(~a)&255));setfCPL 0 0 \$m;a=m;} # from $0.$LINENO\n"
printf "NEG(){ ((m=(0-a)&255));setfSUB 0 \$a \$m;a=m;} # from $0.$LINENO\n"
...
printf "LDrr_$r1$r2(){ $r1=$r2;} # from $0.$LINENO\n"
done

#printf "LDrHLm_$r1(){ (($HL));rb \$hl;$r1=n;} # from $0.$LINENO\n"
printf "LDrHLm_$r1(){ (($HL));memread \$hl;$r1=MEM[hl];} # from $0.$LINENO\n"
#printf "LDHLmr_$r1(){ (($HL));wb \$hl \$$r1;} # from $0.$LINENO\n"
printf "LDHLmr_$r1(){ (($HL));memprotb \$hl \$$r1;MEM[hl]=$r1;} # from $0.$LINENO\n"
#printf "LDrn_$r1(){ rn;$r1=n;} # from $0.$LINENO\n"
printf "LDrn_$r1(){ ldrn$r1;} # from $0.$LINENO\n"
# fixed ordering problem: was $r1=n;rb \$mm;
#printf "LDrIXm_$r1(){ rD;(($IX,mm=(ix+D)&65535));rb \$mm;$r1=n;} # from $0.$LINENO\n"
#printf "LDrIYm_$r1(){ rD;(($IY,mm=(iy+D)&65535));rb \$mm;$r1=n;} # from $0.$LINENO\n"
#printf "LDrIXm_$r1(){ rD;(($IX,mm=ix+D));memread \$mm;$r1=MEM[mm];} # from $0.$LINENO\n"
#printf "LDrIYm_$r1(){ rD;(($IY,mm=iy+D));memread \$mm;$r1=MEM[mm];} # from $0.$LINENO\n"
#printf "LDIXmr_$r1(){ rD;(($IX,mm=ix+D));wb \$mm \$$r1;} # from $0.$LINENO\n"
#printf "LDIYmr_$r1(){ rD;(($IY,mm=iy+D));wb \$mm \$$r1;} # from $0.$LINENO\n"
printf "LDrIXm_$r1(){ rD;(($MMIXD));memread \$mm;$r1=MEM[mm];} # from $0.$LINENO\n"
printf "LDrIYm_$r1(){ rD;(($MMIYD));memread \$mm;$r1=MEM[mm];} # from $0.$LINENO\n"
...
#printf "ADDr_$r1(){ ((m=(a+$r1) &255));setfADD \$a \$$r1 \$m;a=m;} # from $0.$LINENO\n"
#printf "SUBr_$r1(){ ((m=(a-$r1) &255));setfSUB \$a \$$r1 \$m;a=m;} # from $0.$LINENO\n"
#printf "ADCr_$r1(){ ((m=(a+$r1+(f&FC))&255));setfADD \$a \$$r1 \$m;a=m;} # from $0.$LINENO\n"
#printf "SBCr_$r1(){ ((m=(a-$r1-(f&FC))&255));setfSUB \$a \$$r1 \$m;a=m;} # from $0.$LINENO\n"
#printf "CPr_$r1(){ ((m=(a-$r1) &255));setfCP \$a \$$r1 \$m;} # from $0.$LINENO\n" # different
#printf "XORr_$r1(){ ((m=a^$r1));setfXOR \$a \$$r1 \$m;a=m;} # from $0.$LINENO\n"
#printf "ORr_$r1(){ ((m=a|$r1));setfXOR \$a \$$r1 \$m;a=m;} # from $0.$LINENO\n"
#printf "ANDr_$r1(){ ((m=a&$r1));setfAND \$a \$$r1 \$m;a=m;} # from $0.$LINENO\n"
printf "ADDr_$r1(){ ((n=$r1,m=(a+n) &255));$acc_setfADD;a=m;} # from $0.$LINENO\n"
printf "SUBr_$r1(){ ((n=$r1,m=(a-n) &255));$acc_setfSUB;a=m;} # from $0.$LINENO\n"
printf "ADCr_$r1(){ ((n=$r1,m=(a+n+(f&FC))&255));$acc_setfADC;a=m;u=$FC;} # from $0.$LINENO\n"
printf "SBCr_$r1(){ ((n=$r1,m=(a-n-(f&FC))&255));$acc_setfSBC;a=m;u=$FC;} # from $0.$LINENO\n"
printf "CPr_$r1(){ ((n=$r1,m=(a-n) &255));$acc_setfCP;} # from $0.$LINENO\n" # different
printf "XORr_$r1(){ ((n=$r1,m=a^n));$acc_setfXOR;a=m;} # from $0.$LINENO\n"
printf "ORr_$r1(){ ((n=$r1,m=a|n));$acc_setfOR;a=m;} # from $0.$LINENO\n"
printf "ANDr_$r1(){ ((n=$r1,m=a&n));$acc_setfAND;a=m;} # from $0.$LINENO\n"
...
printf "SET$_j$r1(){ (($r1|=$_ORM));} # from $0.$LINENO\n"
printf "RES$_j$r1(){ (($r1&=$_ANM));} # from $0.$LINENO\n"
done
done

#printf "ADDn(){ rn;((m=(a+n) &255));setfADD \$a \$n \$m;a=m;} # from $0.$LINENO\n"
#printf "SUBn(){ rn;((m=(a-n) &255));setfSUB \$a \$n \$m;a=m;} # from $0.$LINENO\n"
#printf "ADCn(){ rn;((m=(a+n+(f&FC))&255));setfADD \$a \$n \$m;a=m;} # from $0.$LINENO\n"
#printf "SBCn(){ rn;((m=(a-n-(f&FC))&255));setfSUB \$a \$n \$m;a=m;} # from $0.$LINENO\n"
#printf "CPn(){ rn;((m=(a-n) &255));setfCP \$a \$n \$m;} # from $0.$LINENO\n" # different
#printf "XORn(){ rn;((m=a^n));setfXOR \$a \$n \$m;a=m;} # from $0.$LINENO\n"
#printf "ORn(){ rn;((m=a|n));setfXOR \$a \$n \$m;a=m;} # from $0.$LINENO\n"
#printf "ANDn(){ rn;((m=a&n));setfAND \$a \$n \$m;a=m;} # from $0.$LINENO\n"
printf "ADDn(){ rn;((m=(a+n) &255));$acc_setfADD;a=m;} # from $0.$LINENO\n"
printf "SUBn(){ rn;((m=(a-n) &255));$acc_setfSUB;a=m;} # from $0.$LINENO\n"
printf "ADCn(){ rn;((m=(a+n+(f&FC))&255));$acc_setfADC;a=m;u=$FC;} # from $0.$LINENO\n"
printf "SBCn(){ rn;((m=(a-n-(f&FC))&255));$acc_setfSBC;a=m;u=$FC;} # from $0.$LINENO\n"
printf "CPn(){ rn;((m=(a-n) &255));$acc_setfCP;} # from $0.$LINENO\n" # different
printf "XORn(){ rn;((m=a^n));$acc_setfXOR;a=m;} # from $0.$LINENO\n"
printf "ORn(){ rn;((m=a|n));$acc_setfOR;a=m;} # from $0.$LINENO\n"
printf "ANDn(){ rn;((m=a&n));$acc_setfAND;a=m;} # from $0.$LINENO\n"

printf "EXDEHL(){ n=d;d=h;h=n;n=e;e=l;l=n;} # from $0.$LINENO\n"
...
#printf "ADD${RP}m(){ $_RB;((m=(a+n) &255));setfADD \$a \$n \$m;a=m;} # from $0.$LINENO\n"
#printf "SUB${RP}m(){ $_RB;((m=(a-n) &255));setfSUB \$a \$n \$m;a=m;} # from $0.$LINENO\n"
#printf "ADC${RP}m(){ $_RB;((m=(a+n+(f&FC))&255));setfADD \$a \$n \$m;a=m;} # from $0.$LINENO\n"
#printf "SBC${RP}m(){ $_RB;((m=(a-n-(f&FC))&255));setfSUB \$a \$n \$m;a=m;} # from $0.$LINENO\n"
#printf "CP${RP}m(){ $_RB;((m=(a-n) &255));setfCP \$a \$n \$m;} # from $0.$LINENO\n" # different
#printf "XOR${RP}m(){ $_RB;((m=a^n));setfXOR \$a \$n \$m;a=m;} # from $0.$LINENO\n"
#printf "OR${RP}m(){ $_RB;((m=a|n));setfXOR \$a \$n \$m;a=m;} # from $0.$LINENO\n"
#printf "AND${RP}m(){ $_RB;((m=a&n));setfAND \$a \$n \$m;a=m;} # from $0.$LINENO\n"
printf "ADD${RP}m(){ $_RB;((m=(a+n) &255));$acc_setfADD;a=m;} # from $0.$LINENO\n"
printf "SUB${RP}m(){ $_RB;((m=(a-n) &255));$acc_setfSUB;a=m;} # from $0.$LINENO\n"
printf "ADC${RP}m(){ $_RB;((m=(a+n+(f&FC))&255));$acc_setfADC;a=m;u=$FC;} # from $0.$LINENO\n"
printf "SBC${RP}m(){ $_RB;((m=(a-n-(f&FC))&255));$acc_setfSBC;a=m;u=$FC;} # from $0.$LINENO\n"
printf "CP${RP}m(){ $_RB;((m=(a-n) &255));$acc_setfCP;} # from $0.$LINENO\n" # different
printf "XOR${RP}m(){ $_RB;((m=a^n));$acc_setfXOR;a=m;} # from $0.$LINENO\n"
printf "OR${RP}m(){ $_RB;((m=a|n));$acc_setfOR;a=m;} # from $0.$LINENO\n"
printf "AND${RP}m(){ $_RB;((m=a&n));$acc_setfAND;a=m;} # from $0.$LINENO\n"
...
printf "JP$RP(){ (($RR,pc=rr));} # from $0.$LINENO\n"
printf "LDSP$RP(){ (($RR,sp=rr));} # from $0.$LINENO\n"
# printf "ADD${RP}SP(){ (($RR,nn=(rr+sp) &65535));setfADD16 \$rr \$sp \$nn;(($SETrpnn));} # from $0.$LINENO\n"
# printf "ADC${RP}SP(){ (($RR,nn=(rr+sp+(f&FC))&65535));setfADC16 \$rr \$sp \$nn;(($SETrpnn));} # from $0.$LINENO\n"
# printf "SBC${RP}SP(){ (($RR,nn=(rr-sp-(f&FC))&65535));setfSBC16 \$rr \$sp \$nn;(($SETrpnn));} # from $0.$LINENO\n"
printf "ADD${RP}SP(){ (($RR,nn=sp,mm=(rr+nn) &65535));$acc_setfADD16;(($SETrpmm));} # from $0.$LINENO\n"
printf "ADC${RP}SP(){ (($RR,nn=sp,mm=(rr+nn+(f&FC))&65535));$acc_setfADC16;(($SETrpmm));u=$FC;} # from $0.$LINENO\n"
printf "SBC${RP}SP(){ (($RR,nn=sp,mm=(rr-nn-(f&FC))&65535));$acc_setfSBC16;(($SETrpmm));u=$FC;} # from $0.$LINENO\n"

#printf "EXSPmHL(){ rw \$sp;(($HL));ww \$sp \$hl;(($SEThlnn));} # from $0.$LINENO\n"
#printf "EXSPmIX(){ rw \$sp;(($IX));ww \$sp \$ix;(($SETixnn));} # from $0.$LINENO\n"
#printf "EXSPmIY(){ rw \$sp;(($IY));ww \$sp \$iy;(($SETiynn));} # from $0.$LINENO\n"
# FIXME: untested
# moved into hl xX yY
#printf "EXSPmHL(){ n=MEM[sp];m=MEM[sp+1];((MEM[sp]=l,MEM[sp+1]=h,l=n,h=m));} # from $0.$LINENO\n"
#printf "EXSPmIX(){ n=MEM[sp];m=MEM[sp+1];((MEM[sp]=X,MEM[sp+1]=x,X=n,x=m));} # from $0.$LINENO\n"
#printf "EXSPmIY(){ n=MEM[sp];m=MEM[sp+1];((MEM[sp]=Y,MEM[sp+1]=y,Y=n,y=m));} # from $0.$LINENO\n"

printf "EXSPm$RP(){ ((n=MEM[sp],m=MEM[sp+1],MEM[sp]=$rl,MEM[sp+1]=$rh,$rl=n,$rh=m));} # from $0.$LINENO\n"
...
printf "INC$RP(){ (($INCrp));} # from $0.$LINENO\n"
printf "DEC$RP(){ (($DECrp));} # from $0.$LINENO\n"
#printf "LD${RP}nn(){ rn;rm;(( $rl=n, $rh=m ));} # from $0.$LINENO\n"
printf "LD${RP}nn(){ ldrpnn$rp;} # from $0.$LINENO\n"
#printf "LD${RP}mm(){ rmm;rb2 \$mm;(( $rl=n, $rh=m ));} # from $0.$LINENO\n"
if $_FAST;then
printf "LDmm$RP(){ rmm;((rr));memprotw \$mm \$rr;MEM[mm]=$rl;MEM[mm+1]=$rh;} # from $0.$LINENO\n"
printf "LD${RP}mm(){ rmm;memread \$mm;$rl=MEM[mm];$rh=MEM[mm+1];} # from $0.$LINENO\n"
#printf "PUSH$RP(){ pushb \$$rh;pushb \$$rl;} # from $0.$LINENO\n"
printf "PUSH$RP(){ MEM[--sp]=$rh;MEM[--sp]=$rl;} # from $0.$LINENO\n"
else
#printf "LDmm$RP(){ rmm;wb2 \$mm \$$rl \$$rh;} # from $0.$LINENO\n"
printf "LDmm$RP(){ rmm;((rr));memprotw \$mm \$rr;MEM[mm]=$rl;((MEM[(mm+1)&65535]=$rh));} # from $0.$LINENO\n"
printf "LD${RP}mm(){ rmm;memread \$mm;$rl=MEM[mm];(($rh=MEM[(mm+1)&65535]));} # from $0.$LINENO\n"
printf "PUSH$RP(){ MEM[sp]=$rh;(($DECSP));MEM[sp]=$rl;(($DECSP));} # from $0.$LINENO\n"
fi

#printf "POP$RP(){ popmn;$rl=n;$rh=m;} # from $0.$LINENO\n"
printf "POP$RP(){ $rl=$pop;$rh=$pop;} # from $0.$LINENO\n"
...
if $_FAST;then
printf "PUSHAF2(){ MEM[--sp]=a;MEM[--sp]=f;u=0xff;} # from $0.$LINENO\n"
else
printf "PUSHAF2(){ MEM[sp]=a;(($DECSP));MEM[sp]=f;(($DECSP));u=0xff;} # from $0.$LINENO\n"
fi
printf "POPAF2(){ f=$pop;a=$pop;k=0xff;} # from $0.$LINENO\n"

printf "# SP instructions - timing checked\n"
printf "LDSPnn(){ rnn;sp=nn;} # from $0.$LINENO\n"
#printf "LDmmSP(){ rmm;ww \$mm \$sp;} # from $0.$LINENO\n"
printf "LDmmSP(){ rmm;memprotw \$mm \$sp;((MEM[mm]=sp&255,MEM[mm+1]=(sp>>8)));} # from $0.$LINENO\n"
#printf "LDSPmm(){ rmm;rw \$mm;sp=nn;} # from $0.$LINENO\n"
printf "LDSPmm(){ rmm;memread \$mm;((sp=MEM[mm]+(MEM[mm+1]<<8)));} # from $0.$LINENO\n"
printf "INCSP(){ (($INCSP));} # from $0.$LINENO\n"
printf "DECSP(){ (($DECSP));} # from $0.$LINENO\n"

printf "EXAFAF(){ n=a;a=a1;a1=n;n=f;f=f1;f1=n;u=0xff;} # from $0.$LINENO\n"
# printf "EXX(){ for g in b c d e h l;do eval \"((n=\$g,\$g=\${g}1,\${g}1=n))\";done;} # from $0.$LINENO\n"
DF=
for g in b c d e h l;do
DF+="n=$g,$g=${g}1,${g}1=n,"
done
printf "EXX(){ ((${DF:: -1}));} # from $0.$LINENO\n"

printf "# RST instructions - flags, timing checked\n"
for p in '00' '08' 10 18 20 28 30 38;do
printf "RST$p(){ pushw \$pc;pc=0x00$p;} # from $0.$LINENO\n"
done
